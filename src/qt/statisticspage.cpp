...
void StatisticsPage::updateStatistics()
{
    ...
    {
		subsidy = "600,000 CK per block";
    }
	else if(pindexBest->nHeight < 250)
    {
		subsidy = "1 CK per block";
    }
	else if(pindexBest->nHeight < 1500000)
    {
		subsidy = "20 CK per block";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " CK" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " CK" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " CK");
    }
